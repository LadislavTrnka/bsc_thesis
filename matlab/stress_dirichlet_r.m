% To compute stress formulation with Dirichlet boundary conditions by the resampling technique
...
%letter='B';
if letter=='A'
    P=blkdiag(Res2,Res3,Res); %A - oscillations in sigma:x and sigma_y
elseif letter=='B'
    P=blkdiag(Res3,Res,Res2); %B - oscillations in shear
end
%P=blkdiag(Res,Res2,Res3); %Large oscillations - condition number 9.3523e+08 for 40x40
